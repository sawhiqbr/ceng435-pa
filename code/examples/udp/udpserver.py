...
LOCAL_IP              = "server"
LOCAL_PORT            = 20002
BUFFER_SIZE           = random.randint(1000, 10000) // 500 * 500
CURRENT_DIRECTORY     = os.getcwd()
TIMEOUT               = 0.1
SOCKET_TIMEOUT        = 0.5
WINDOW_SIZE           = 128
THREAD_COUNT          = random.randint(16, 192) // 16 * 16
SEND_BASE             = 1
TOTAL_CHUNKS_ALL      = 0
...
print(f"Testing with BUFFER_SIZE: {BUFFER_SIZE} and THREAD_COUNT: {THREAD_COUNT}")
